function injectDiv() {
	if (CARD.checkLogin()) {
		...
		html += '        </ul>';
		html += '        <div id="tabs-1">';
		html += '            <div id="stoves" class="width_87"></div>';
		html += '            <div id="steal_friends" class="width_87">';
		html += '            </div>';
		html += '        </div>';
		html += '        <div id="tabs-2">';
		html += '            <div class="width_87"><div id="random"></div><div class="option"></div></div>';
		html += '            <div id="exchange" class="width_87"></div>';
		html += '            <div id="coffer" class="width_87"></div>';
		html += '        </div>';
		html += '        <div id="tabs-3">';
